...
Library.prototype.addBook = function (title, author, pages, read) {
  ...
  localStorage.setItem(this.bookId, JSON.stringify(newBook));
...
Library.prototype.listBooks = function () {
  ...
  for (let id in window.localStorage) {
    ...
    if (book) {
      ...
      read.addEventListener("click", (e) => alert("R"));
      update.addEventListener("click", (e) => alert("U"));
      del.addEventListener("click", (e) => alert("D"));
    }
  }
};
...
library.addBook("Ender's Game", "Orson Scott Card", 324, true);
library.addBook("The Dark Tower: The Gunslinger", "Stephen King", 300, true);
